...
export const ui = {
	en: {
		...
		// Hero
		"hero.slogan": "We Design,",
		"hero.subtitle": "You Profit",
		"hero.description":
			"From design ideas to working production lines. we power your industrial lines and machines",
		"hero.buttons.seeProducts": "See our Products",
		"hero.buttons.contactUs": "Contact Us",
		// Stats
		"stats.title": "What we offer",
		"stats.description":
			"We offer over 50 machine designs crafted with over 20 years of experience",
		// Steps
		...
		"getStarted.first.description":
			"Browse over 50 machine designs and production lines and select the perfect one for your needs",
	...
	ar: {
		...
		"hero.description":
			"من تصميمات إلى خطوط إنتاجية . نحن ندعم كافة أنواع	الحلول الصناعية",
		"hero.buttons.seeProducts": "تصفح منتجاتنا",
		"hero.buttons.contactUs": "اتصل بنا",
		// Stats
		"stats.title": "ما نقدمه",
		"stats.description":
			"نحن نقدم ما يعادي الـ50 تصميم للماكينات و خطوط الإنتاج تم تصميمها و بعناية بمساعدة خبراتنا التي تفوق ال 20 عاماً في مجال التصنيع",
		// Steps
		...
		"getStarted.first.description":
			"تصفح من بين أكثر من 50 تصميم و خط إنتاج و اختر المنتج المناسب لك",
		...
		"product.title": "منتج",
		"product.model": "موديل",
		"product.productionRate": "معدل الانتاج",
